...
const { createPost, getAllPosts, likePost, commentPost, editPost, deletePost, editComment, deleteComment, getMyPosts, getPostById } = require("../controllers/postController");
